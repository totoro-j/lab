	...
	<div id="left" style="height: 908px;">
		<ul class="l_menu" style="display:block;">
	        ...
	        <ul style="display:none;" class="detail">
                 ...
                 <li><a href="__APP__/Recycle/recycle_search_stop">停用实验回收站</a></li>
                 <li><a href="__APP__/Recycle/recycle_user_apply">用户申请回收站</a></li>
                 <li><a href="__APP__/Recycle/recycle_user_stop">停用用户回收站</a></li>
	        </ul>
