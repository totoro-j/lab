...
<h2 style="color:#219E69;margin:0 auto;"> 审核注册用户</h2>
   <div class="check_table">
   <table class="appointment_check" id="appointment_check">
   <tr>
   <th>用户名</th><th>用户姓名</th><th>课题组负责人</th><th>注册时间</th><th>审核情况</th><th colspan="2">审核操作</th>
   </tr>
 <tr><td colspan="7" id="notfound">未找到相关数据</td></tr>
   		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  <td><a href="__URL__/check/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["username"]); ?></a></td>
  <td><a href="__URL__/check/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["truename"]); ?></a></td>
  <td><a href="__URL__/check/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["principal"]); ?></a></td>
