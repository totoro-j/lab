<?php if (!defined('THINK_PATH')) exit();?><!doctype html><html><head><meta charset="utf-8"><title>预约审核模块</title><link rel="stylesheet" href="__PUBLIC__/Css/Admin/user_check.css" ><script src="__PUBLIC__/Js/jquery.js" type="text/javascript"></script><script type="text/javascript">	      $(function(){  
		$(".pass1").click
		(
		function(){
...
</script></head><body onLoad="validateTel()"><h2 style="color:#219E69;margin:0 auto;"> 审核预约申请</h2><div class="check_table"><table class="appointment_check" id="appointment_check"><tr><th>实验名称</th><th>用户姓名</th><th>课题负责人</th><th>申请时间</th><th>审核情况</th><th colspan="2">审核操作</th></tr><tr><td colspan="7" id="notfound">未找到相关数据</td></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><a href="__URL__/checkentry/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["testname"]); ?></a></td><td><a href="__APP__/User/check/id/<?php echo ($vo["uid"]); ?>"><?php echo ($vo["truename"]); ?></a></td><td><?php echo ($vo["principal"]); ?></td><td><?php echo ($vo["time"]); ?></td><td><div id="check_button1" class="check_button"><a >等待通过</a></div></td><td><a href="__URL__/pass/id/<?php echo ($vo["id"]); ?>"><div class="pass1">通过</div></a></td><td><a href="__URL__/refuse/id/<?php echo ($vo["id"]); ?>"><div class="refuse1">拒绝</div></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></table><div class="user_show"><?php echo ($show); ?></div></div></body></html>