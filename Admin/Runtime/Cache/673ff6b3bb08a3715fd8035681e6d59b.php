...
<h2 style="color:#219E69;margin:0 auto;"> 审核预约申请</h2>
 ...
 <td colspan="7" id="notfound">未找到相关数据</td></tr>
  ...
  <td><a href="__URL__/checkentry/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["testname"]); ?></a></td>
  <td><a href="__APP__/User/check/id/<?php echo ($vo["uid"]); ?>"><?php echo ($vo["truename"]); ?></a></td>
