...
<meta charset="utf-8">
<title>修改用户信息</title>
<link rel="stylesheet" type="text/css" href="__PUBLIC__/Css/Admin/user_view.css" />
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tt">
   <td><a href="__URL__/check/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["truename"]); ?></td>
  ...
  <script>
	if('<?php echo ($vo["password"]); ?>'=='20575ebc2b40c6eb6f3f51fd9f0ae5fa'){
