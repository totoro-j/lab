...
<!--section No.1 begin-->
  ...
  <div class="edit_section" >
     ...
     <form class="content" action="__URL__/ListFocusUpdate" method='post'  id='content' name='content'>
     <input type='hidden' name='id' value="<?php echo ($data["id"]); ?>"/>
	     ...
	     <input type="text" name='title' class="title" id="title" value="<?php echo ($data["title"]); ?>"/><span id="warn1" class="warm" style="display:none;"></span>    	 
		     ...
		     <input type="text"  name="editor" class="title" id="author" value="<?php echo ($data["editor"]); ?>"/><span id="warn2" class="warm" style="display:none;"></span>
       </div>
