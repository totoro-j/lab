...
</script></head><body><!--container begin--><div class="container_wrapper"><!--each edit section begin--><!--section No.1 begin--><h3>焦点新闻</h3><div class="edit_section" ><form class="content" action="__URL__/ListNewsUpdate" method='post'  id='content' name='content'><input type='hidden' name='id' value="<?php echo ($data["id"]); ?>"/><div class="art_title" ><p>标题</p><input type="text" name='title' class="title" id="title" value="<?php echo ($data["title"]); ?>"/><span id="warn1" class="warm" style="display:none;"></span><div class="art_title" ><p>作者</p><input type="text" class="title" name="editor" id="author" value="<?php echo ($data["editor"]); ?>"/><span id="warn2" class="warm" style="display:none;"></span></div><div class="art_title" ><p>简介</p><input  placeholder="请填写50字以内简介" type="text" class="title" name="metacontent" id="metacontent" value="<?php echo ($data["metacontent"]); ?>"/><span id="warn3" class="warm" style="display:none;"></span></div></br></br><div class="new"><textarea name="myEditor" id="myEditor"><?php echo ($data["content"]); ?></textarea><script>CKEDITOR.replace( 'myEditor',
{
