...
<body>
 <h2 style="color:#219E69;margin:0 auto;font-weight:bold;text-align:left;font-size:24px;">综合新闻</h2>
    <div class="container">
       <h3 style="color:#000;">新闻列表</h3>
          
           <table class="article_list">
           
           <caption class="add_article"><a href="__URL__/ListNewsEdit/">上传文章</a></caption>
	  	
	   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["isshow"] == 1): ?><tr class="article_table"><th><a href="__URL__/ListNewsView/id/<?php echo ($vo["id"]); ?>" style="color:#1a1a1a;font-size:15px;"><?php echo ($vo["title"]); ?></a></th><td><a href="__URL__/ListNewsIsshowCancel/id/<?php echo ($vo["id"]); ?>" class="opendiv3" id="setnews3">取消显示到首页</a></td><td><a href="__URL__/ListNewsDel/id/<?php echo ($vo["id"]); ?>)" class="delete"  onClick="return confirm('确认删除？')">删除</a></td></tr>                              	  
	   <?php else: ?>	  
	   <tr class="article_table"><th><a href="__URL__/ListNewsView/id/<?php echo ($vo["id"]); ?>" style="color:#1a1a1a;font-size:15px;"><?php echo ($vo["title"]); ?></a></th><td><a href="__URL__/ListNewsIsshow/id/<?php echo ($vo["id"]); ?>" class="opendiv3" id="setnews3">显示到首页</a></td><td><a href="__URL__/ListNewsDel/id/<?php echo ($vo["id"]); ?>)" class="delete"  onClick="return confirm('确认删除？')">删除</a></td></tr><?php endif; endforeach; endif; else: echo "" ;endif; ?> 
