...
<!--summary list start-->
  <div class="summary">
	<?php if(is_array($focus_list)): $i = 0; $__LIST__ = $focus_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="summary_list">
             <img  onerror="this.src='__PUBLIC__/Images/uestc.ico'" src="__PUBLIC__/Images/m_<?php echo ($vo["metaimg"]); ?>">
             <div class="summry_list_info">
                 <h3><a href="__URL__/n/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h3>
                 <span><?php echo ($vo["date"]); ?></span>  <!--came out time-->
                 <p style="text-align:left"><a href="__URL__/n/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["metacontent"]); ?></a></p>
             </div>
