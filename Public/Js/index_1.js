        ...
        showDate.prototype.init = function () {
            ...
            for (var i = 0; i < _self.td.length; i++) {
                _self.td[i].onclick = function () {
                    ...
                    else if(newMn<10&&newDd<10)
                    {
                    _self.dateText.value = newYear + "-" +"0"+ newMn + "-" +"0"+  newDd;
                    _self.dateBox.className += " ";
                    _self.dateBox.className += "dn";
                    }
                     else if(newMn<10&&newDd>=10)
                    {
                    _self.dateText.value = newYear + "-" +"0"+ newMn + "-" + newDd;
                    _self.dateBox.className += " ";
                    _self.dateBox.className += "dn";
                    }
                    else if(newMn>=10&&newDd<10)
                    {
                    _self.dateText.value = newYear + "-" + newMn + "-" +"0"+ newDd;
                    _self.dateBox.className += " ";
                    _self.dateBox.className += "dn";
                    }
                     else if(newMn>=10&&newDd>=10)
